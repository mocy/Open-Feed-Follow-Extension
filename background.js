...
chrome.extension.onRequest.addListener(function(request, sender) {
  if (request.msg == "feedIcon") {
    ...
    chrome.pageAction.setTitle(
      { tabId: sender.tab.id,
        title: chrome.i18n.getMessage("of_follow_action_title")
      });
